...
.small--window {
  ...
  .middle-product__photo--big {
    ...
    height: 2rem;
    border-radius: 5px;
    background: url("/static/img/cooper-products-1.jpg") no-repeat;
    margin: 0 auto;
    background-size: auto 100%;
    margin-top: 0.27rem;
  }
